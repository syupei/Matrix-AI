...
适用：`content-design-review`。版本：guidance-index/0.1。
...
| R01 | [中文情境案例](references/context-cases.md) | 方法指引；对应任务 | 沿用 |
| R02 | [审读及接力记录](references/review-and-handoff.md) | 方法指引；对应任务 | 沿用 |
