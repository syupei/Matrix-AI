...
适用：`project-management-agent`。版本：guidance-index/0.1。
...
| R01 | [分层任务工具 0.1](references/task-runtime.md) | 依据/接续规则；对应任务 | 沿用 |
| R02 | [从需求到交付的编排](references/workflow.md) | 方法指引；对应任务 | 沿用 |
